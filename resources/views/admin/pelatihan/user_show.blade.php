...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    ...
    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Peserta</button>
    </a>
  </li>
  <li class="nav-item" role="presentation">
    <a href="{{url('pelatihan/pengajar').'/'.$data_pelatihan->id }}">
    <button class="nav-link" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Pengajar</button>
    </a>
  </li>
</ul>
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{url('pelatihan/peserta_create').'/'.$data_pelatihan->id }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="hidden" name="jenis" value="peserta" />
            ...
            <div class="card-body p-0 table-responsive">
                <table class="table table-bordered table-striped table-hover mb-0">
                    ...
                    <tr>
                        ...
                        <td>{{ $row->name }}</td>
                        <td>
                            <form method="POST" action="{{ url('pelatihan/peserta_delete', $row->id, 'peserta') }}" style="display: inline-block;">
                                @csrf
                                @method('DELETE')

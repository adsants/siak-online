    ...
    <div class="card-body p-4">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @endforeach
                @endif
                <form action="{{url('soal/store') }}" method="POST" class="form-horizontal" id="form_zstandard">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <textarea class="ckeditor" required name="soal">{{ old('soal') }}</textarea>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <label class="mt-radio mt-radio-outline">
                                    <input type="radio" name="status_jawaban"  value="1"> 
                                    Jawaban Benar
                                    <span></span>
                                </label>	
                            </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-12" >Jawaban 2 :</label>
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <label class="mt-radio mt-radio-outline">
                                        <input type="radio" name="status_jawaban"  value="2"> 
                                        Jawaban Benar
                                        <span></span>
                                    </label>	
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                            <textarea class="ckeditor" name="jawaban_3">{{ old('jawaban_3') }}</textarea>
                            </div>
                            <div class="col-sm-2">
                                <label class="mt-radio mt-radio-outline">
                                    <input type="radio" name="status_jawaban"  value="3"> 
                                    Jawaban Benar
                                    <span></span>
                                </label>	
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                            <textarea class="ckeditor"  name="jawaban_4">{{ old('jawaban_4') }}</textarea>
                            </div>
                            <div class="col-sm-2">
                                <label class="mt-radio mt-radio-outline">
                                    <input type="radio" name="status_jawaban"  value="4"> 
                                    Jawaban Benar
                                    <span></span>
                                </label>	
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                            <textarea class="ckeditor"  name="jawaban_5">{{ old('jawaban_5') }}</textarea>
                            </div>
                            <div class="col-sm-2">
                                <label class="mt-radio mt-radio-outline">
                                    <input type="radio" name="status_jawaban"  value="5"> 
                                    Jawaban Benar
                                    <span></span>
                                </label>	
                            </div>
